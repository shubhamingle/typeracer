...
def gameframe(xmove):
    ...
    if choice == mylist1:
        ...
        w.create_text(410, 180, text=text1, font=("Comic Sans MS", 12))
    if choice == mylist2:
        ...
        w.create_text(410, 180, text=text2, font=("Comic Sans MS", 12))
    if choice == mylist3:
        ...
        w.create_text(400, 180, text=text3, font=("Comic Sans MS", 12))

    # road and cars
    img3 = r'C:\Users\Shubham\Desktop\Python project\road4.png'
    photo3 = PhotoImage(file=img3)
    w.create_image(55, 65, image=photo3)

    img1 = r'C:\Users\Shubham\Desktop\Python project\carb.png'
    photo1 = PhotoImage(file=img1)
    car1 = w.create_image(55, 95, image=photo1)

    img2 = r'C:\Users\Shubham\Desktop\Python project\cara.png'
    ...
    def retrieve_input(temp):
        ...
        if temp == "comma":
            temp = ","
        if temp != choice[i]:
            if temp != "Caps_Lock" and temp != "BackSpace":
                count = count + 1
        if temp == "BackSpace":
            if count > 0:
                count = count - 1
    ...
    def check_position():
        global inc, wcount
        if speed2 == 690 and speed1 < 690 and inc == 0:
        ...
        elif speed1 == 690 and speed2 < 690 and inc == 0:
            FRAME = Frame(app, width=245, height=150)
            FRAME.place(x=555, y=0)
